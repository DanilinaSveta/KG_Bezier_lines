...
public class TestBezier extends JPanel {
...
//            g2.drawString("Линии Безье 4-го порядка",20, 20);
//            g2.drawString("Для аппроксимации окружности расположите три точки на плоскости",20, 35);
            ...
            // 4 кривых Бесселя
            if (keyPointNum == 3) {
                double KPP_0X = ((keyPointP[0].getX() + keyPointP[2].getX())/2);
                double KPP_0Y = ((keyPointP[0].getY() + keyPointP[2].getY())/2);
                g2.draw(keyPointE[0]);
                double kPx = (keyPointE[0].x + keyPointE[2].x)/2;
                double kPy = (keyPointE[0].y + keyPointE[2].y)/2;
                g2.drawString("A  E", (int) kPx, (int) kPy);
                g2.drawLine((int) KPP_0X, (int) KPP_0Y, (int) keyPointP[0].getX(),
                        (int) keyPointP [0].getY ()); // красить прямую линию между ключевыми точками
                g2.drawLine((int) KPP_0X, (int) KPP_0Y, (int) keyPointP[2].getX(),
                        (int) keyPointP [2].getY ()); // красить прямую линию между ключевыми точками
                double x, y;
                g2.setColor(Color.RED);
                for (double k = t; k <= 1 + t; k += t) {
                    double r = 1 - k;
                    x = Math.pow(r, 4) * KPP_0X + 4 * k * Math.pow(r, 3) * keyPointP[0].getX()
                            + 6 * Math.pow(k,2) * Math.pow(r,2) *keyPointP[1].getX()
                            + 4 * Math.pow(k, 3) * (1 - k) * keyPointP[2].getX() + Math.pow(k, 4) * KPP_0X;
                    y = Math.pow(r, 4) * KPP_0Y + 4 * k * Math.pow(r, 3) * keyPointP[0].getY()
                            + 6 * Math.pow(k,2) * Math.pow(r,2) *keyPointP[1].getY()
                            + 4 * Math.pow(k, 3) * (1 - k) * keyPointP[2].getY() + Math.pow(k, 4) * KPP_0Y;
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (e.getButton() == MouseEvent.BUTTON1) {
                    if (keyPointNum  < 3) {
                        ...
                        keyPointE[keyPointNum] = new Ellipse2D.Double(x - 3, y - 3, 8, 8);
                        keyPointNum++;
                        repaint();
                    }
        ...
        class MouseMotion extends MouseMotionAdapter {
            ...
            public void mouseDragged(MouseEvent e) {
                ...
                if (keyPointID != -1) {
                    ...
                    keyPointE[keyPointID] = new Ellipse2D.Double(x - 3, y - 3, 8, 8);
                    repaint();
                }
            }
        }
    ...
    public TestBezier(JTabbedPane pnlMain) {
;
            keyPointNum = 0;
            keyPointP = new Point2D[5];
            keyPointE = new Ellipse2D.Double[5];
            ...
            pnlMain.add("Безье 4-го порядка",bezierPanel);
